...
/**
 * Class for intensity method application call to model.
 */
public class HandleIntensityComponent extends HandleConstruct implements HandleInterfaceCommand {

  /**
   * Constructs a HandleIntensityComponent object with the specified ImageModel and image map.
   *
   * @param imageFilter The ImageModel to be used for processing.
   * @param imageMap    The image map containing image data.
   */
  public HandleIntensityComponent(ExtendedImageModel imageFilter, Map<String, int[][][]> imageMap) {
  ...
  public void apply(String[] tokens) {
    ...
    if (imageFromHashMap == null) {
      ...
      int[][][] intensityComponentArray = imageFilter.calculateIntensity(imageFromHashMap);
      imageMap.put(outputImageName, intensityComponentArray);
    }
  }
}