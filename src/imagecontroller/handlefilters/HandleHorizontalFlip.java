 ...
 */
public class HandleHorizontalFlip extends HandleConstruct implements HandleInterfaceCommand {

  /**
   * Constructs a HandleHorizontalFlip object with the specified ImageModel and image map.
   *
   * @param imageFilter The ImageModel to be used for processing.
   * @param imageMap    The image map containing image data.
   */
  public HandleHorizontalFlip(ExtendedImageModel imageFilter, Map<String, int[][][]> imageMap) {
  ...
  public void apply(String[] tokens) {
    ...
    if (imageFromHashMap == null) {
      ...
      int[][][] flippedArrayHorizontally = imageFilter.flipHorizontally(imageFromHashMap);
      imageMap.put(outputImageName, flippedArrayHorizontally);
    }
  }
}
